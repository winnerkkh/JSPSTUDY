		...
		<h2><%=mbean.getId() %> 회원님 정보 보기</h2>
			<table width="400" border="1">
				...
				<tr height="50">
					...
					<button onclick="location.href='MemberList.jsp?id=<%=mbean.getId()%>'">목록 보기</button>
					<button onclick="location.href='MemberJoin.jsp?id=<%=mbean.getId()%>'">회원 가입</button>
					</td>
				</tr>
